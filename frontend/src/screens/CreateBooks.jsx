...
const CreateBooks = () => {
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-purple-600 rounded-xl w-[100] p-4 mx-auto '>
        <div className='my-4'>
        ...
        <button className='p-2 bg-purple-800 rounded-md m-8 text-white' onClick={handleSaveBook}>Add Book</button>
